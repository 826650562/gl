...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/static/assets/vendor/toastr/toastr.min.css">
    <!-- MAIN CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="index.html">
                    <img src="${basePath}/static/assets/img/logo_white_2.png" class="img-responsive logo">
                </a>
            </div>
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li>
                            <a href="addmodel.html" class="active">
        ...
        <div class="main">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="case-name" placeholder="请输入新建部件的名称...">
                            </div>
                            <div class="form-group">
                                <label for="case-type">案例类别:</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo">
                                    ...
                                    <div class="plus-tag tagbtn clearfix" id="myTags" style="display: none;">
                                        <a value="-1" title="Travel" href="javascript:void(0);">
                                            <span>Travel</span>
                                            <em></em>
                                        </a>
                                    </div>
                                    ...
                                    <div class="plus-tag-add">
                                        <form id="" action="" class="login">
                                            <ul class="Form FancyForm clearfix" style="margin-bottom:0;">
                                                <li>
                                                    <input id="" name="" type="text" class="form-control" maxlength="20" placeholder="请输入新建标签名...">
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-primary">添加新标签</button>
                                                    <a href="javascript:void(0);" class="plus">收起推荐标签</a>
                                                </li>
                                            </ul>
                                        </form>
                                    </div>
                                    ...
                                    <div id="mycard-plus" >
                                        <div class="default-tag tagbtn">
                                            <div class="clearfix nowtips">
                                                <a value="-1" title="Travel" href="javascript:void(0);" class="selected">
                                                    <span>Travel</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Internet" href="javascript:void(0);" class="">
                                                    <span>Internet</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="it" href="javascript:void(0);">
                                                    <span>it</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="French" href="javascript:void(0);">
                                                    <span>French</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="English" href="javascript:void(0);">
                                                    <span>English</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="JAVA" href="javascript:void(0);">
                                                    <span>JAVA</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Photograph" href="javascript:void(0);">
                                                    <span>Photograph</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Sculpture" href="javascript:void(0);" class="selected">
                                                    <span>Sculpture</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Drawing" href="javascript:void(0);" class="selected">
                                                    <span>Drawing</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Jazziness" href="javascript:void(0);" class="selected">
                                                    <span>Jazziness</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Running" href="javascript:void(0);" class="">
                                                    <span>Running</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="PHP" href="javascript:void(0);">
                                                    <span>PHP</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Dreamweaver" href="javascript:void(0);">
                                                    <span>Dreamweaver</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Shopping" href="javascript:void(0);">
                                                    <span>Shopping</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Writing" href="javascript:void(0);">
                                                    <span>Writing</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Diving" href="javascript:void(0);">
                                                    <span>Diving</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Basketball" href="javascript:void(0);">
                                                    <span>Basketball</span>
                                                    <em></em>
                                                </a>
                                                <a value="-1" title="Reading" href="javascript:void(0);">
                                                    <span>Reading</span>
                                                    <em></em>
                                                </a>
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo">
                                    <div class="upload-img" style="position:relative;margin-left:0;">
                                        <input type="file">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="success-modal" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
                 <div class="modal-dialog" role="document">
	                 <div class="modal-body">
	                     <div class="alert alert-success alert-dismissible" role="alert" style="font-size: 16px;">
	                     <button type="button" class="close" style="top:2px;" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><i class="fa fa-check-circle"></i>&nbsp;新建成功！</div>
	                 </div>
                 </div>
             </div>
             
             <div class="modal fade" id="alert-modal" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
                 <div class="modal-dialog" role="document">
	                 <div class="modal-body">
	                     <div class="alert alert-danger alert-dismissible" role="alert" style="font-size: 16px;">
	                     	<button type="button" class="close" style="top:2px;" data-dismiss="alert" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button>
